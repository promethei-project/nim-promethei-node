...
##
## When declaring a new type, one should consider importing the `promethei/logutils`
...
## below. **Only `promethei/logutils` needs to be imported.**
##
## Using `logutils` in the Promethei codebase:
## - Instead of importing `pkg/chronicles`, import `pkg/promethei/logutils`
...
##   `pkg/serde/json` or use Promethei-specific overloads by importing `utils/json`
